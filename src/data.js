export const blogs = [
    {
        ...
        description:
            "Amsterdam Nightlife Guide has been written by our Netherlands content specialist – Alara Benlier, who has lived in the country. With its famous canals, legendary coffeeshops, fascinating museums, and its extraordinary nightclubs, Amsterdam is one of the most visited and loved cities in the entire world. If you are looking for an unforgettable night out, this dazzling city offers the best one. The capital of the Netherlands has grown to become one of Europe’s coolest cities to party since Amsterdam clubs are appealing to everyone.",
    },
    {
...
export const packages = [
    {
        ...
        price: "100",
        description:
            "This package will save some money for you. I will suggest you some places to visit in the city. You can also choose to visit some places that you like. I will guide you afterwards",
    ...
    },
    {
        ...
        price: "200",
        description:
            "This package will cost you a little bit more. I personally think you should choose this package. I will send a guide with you to show places that you like.",
    ...
    },
    {
        ...
        price: "300",
        description:
            "This is the ultimate package you have ever wanted. You will be benefited with literally everything you want. In addition you will get discounts on hotel bookings",
